...
I<C<name>>: The name of the attribute to create or alter@value: Value to set in string form
...
I<C<qualifiedName>>: The qualifiedName of the attribute to create or alter@value: Value to set in string form
