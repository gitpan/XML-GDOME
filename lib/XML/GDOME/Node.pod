...
Inserts the node I<newChild> before the existing child node @refChild. If I<refChild> is undef, insert I<newChild> at the end of the list of children. If I<newChild> is a DocumentFragment node, all of its children are inserted, in the same order, before @refChild. If the I<newChild> is already in the tree, it is first removed.
...
I<C<version>>: This is the version number of the feature to test. In Level 2,           version 1, this is the string "2.0". If the version is not           specified, supporting any version of the feature will cause the           method to return %TRUE.
